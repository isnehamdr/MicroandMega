...
export default function AddToCart() {
    ...
    const handleApplyCoupon = async (e) => {
        ...
        try {
            ...
            setCouponError('')
            const res = await axios.post('/coupons/validate', { code, subtotal })
            setAppliedCoupon({ code: res.data.data.code, label: res.data.data.label })
                                    ...
                                    {appliedCoupon ? (
                                        ...
                                        <form onSubmit={handleApplyCoupon} className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 min-w-0 px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#bb1403] focus:border-[#bb1403] disabled:opacity-60"
                                            />
                                            <button
                                                type="submit"
                                                disabled={couponLoading}
                                                className="px-4 py-2.5 text-sm font-bold text-white bg-gray-800 hover:bg-gray-900 rounded-lg transition-colors flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
