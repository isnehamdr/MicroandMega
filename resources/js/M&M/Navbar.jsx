...
const CartIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 1.72-4.79 1.749-7.324a.75.75 0 00-.746-.826H5.106M7.5 14.25L5.106 5.166M7.5 14.25L5.98 20.25m11.02-6H7.5m9.5 6a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm-9 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
  </svg>
)
        ...
        >
          ...
          <div className="flex items-center gap-2 lg:gap-3 flex-shrink-0">
            ...
            <button
              ...
              className={`relative inline-flex items-center justify-center w-9 h-9 lg:w-11 lg:h-11 rounded-full border transition-colors flex-shrink-0 cursor-pointer bg-transparent
                ${cartOpen
                  ? 'border-[#bb1403] text-[#bb1403] bg-red-50'
                  : 'border-gray-200 text-gray-600 hover:text-[#bb1403] hover:border-[#bb1403]/40 hover:bg-red-50'}`}
            >
              <CartIcon className="w-5 h-5 lg:w-6 lg:h-6" />
              {itemCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 rounded-full bg-[#bb1403] text-white text-[10px] font-bold leading-none">
      ...
      {mobileOpen && (
        ...
        >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`relative w-9 h-9 flex items-center justify-center rounded-lg border transition-colors
                  ${isActive('/add-to-cart')
                    ? 'border-[#bb1403] text-[#bb1403] bg-red-50'
                    : 'border-gray-200 text-gray-600 hover:bg-gray-50'}`}
              >
                <CartIcon className="w-5 h-5" />
                {itemCount > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[16px] h-[16px] px-1 rounded-full bg-[#bb1403] text-white text-[9px] font-bold leading-none">
                    {itemCount > 9 ? '9+' : itemCount}
                  </span>
                )}
              </button>
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-0.5">
            ...
            {/* Shopping Cart as a full nav row too */}
            <Link
              href="/add-to-cart"
              className={`flex items-center justify-between px-3 py-3 text-[15px] font-semibold rounded-lg transition-colors no-underline
                ${isActive('/add-to-cart') ? 'text-[#bb1403] bg-red-50' : 'text-gray-700 hover:text-[#bb1403] hover:bg-red-50'}`}
            >
              ...
              {itemCount > 0 && (
                <span className="flex items-center justify-center min-w-[20px] h-[20px] px-1.5 rounded-full bg-[#bb1403] text-white text-[11px] font-bold leading-none">
                  {itemCount}
                </span>
              )}
            </Link>
